                ...
                <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] gap-12 lg:gap-0 mb-20 items-start">
                    ...
                    <div className="flex flex-col pr-0 lg:pr-16">
                        ...
                        {[
                            ...
                            >
                                {item.href ? (
                                    <a href={item.href} className="flex items-center gap-5 mb-3 group transition-opacity hover:opacity-70">
                                        <div className="w-14 h-14 bg-brand-dark flex-shrink-0 flex items-center justify-center group-hover:bg-brand-orange transition-colors duration-300">
                                            {item.icon}
                                        </div>
